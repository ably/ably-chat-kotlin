...
public interface ChatClientOptions {
    ...
    /**
     * The coroutine context used for managing the state updates within the chat client.
     * This context allows for controlling concurrency and dispatching tasks related
     * to state management.
     */
    @ExperimentalChatApi
    public val stateDispatcher: CoroutineDispatcher
}
...
public class MutableChatClientOptions : ChatClientOptions {
    ...
    @ExperimentalChatApi
    override var stateDispatcher: CoroutineDispatcher = DefaultStateDispatcher
}
