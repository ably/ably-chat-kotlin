 ...
 * @param limit The number of messages to load per page.
 *
...
@Composable
@Suppress("LongMethod")
public fun Room.collectAsPagingMessagesState(scrollThreshold: Int = 10, limit: Int = 100): PagingMessagesState {
    ...
    LaunchedEffect(this, error, shouldRequestMessages) {
        ...
        val receivedPaginatedResult = try {
            lastReceivedPaginatedResult?.next()
                ?: subscription!!.getPreviousMessages(limit = limit)
